export default function BoxList({ inputValue, deleteItem, title, completedItem }) {
    ...
    return (
        <article className=" bg-linear-to-b from-grayPin to-blackPin text-beigePin drop-shadow-2xl w-85 sm:w-96 lg:w-96 xl:w-80 2xl:w-96 max-w-96 max-h-none h-fit rounded-lg p-5 mb-5 mx-5">
